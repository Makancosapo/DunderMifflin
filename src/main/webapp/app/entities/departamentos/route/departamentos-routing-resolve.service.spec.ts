...
import departamentosResolve from './departamentos-routing-resolve.service';

describe('Departamentos routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: DepartamentosService;
  let resultDepartamentos: IDepartamentos | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IDepartamentos returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        departamentosResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDepartamentos).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDepartamentos>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
