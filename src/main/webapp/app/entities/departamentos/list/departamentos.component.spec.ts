...
import { sampleWithRequiredData } from '../departamentos.test-samples';
...
describe('Departamentos Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to departamentosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDepartamentosIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDepartamentosIdentifier).toHaveBeenCalledWith(entity);
